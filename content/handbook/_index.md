...
| Area | Guides |
| --- | --- |
| Identity and Active Directory | [Directory discovery](active-directory/discovery/), the new [Kerberos section](active-directory/kerberos/), [certificate services](active-directory/certificate-services/), [trusts](active-directory/trusts/), [domain-level control paths](active-directory/privileged-control-review/), and [lateral movement paths](active-directory/lateral-movement/) |
